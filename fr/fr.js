window.onload = function() {
    let questionCount = 0;
    let questions = ['bonjour', 'merci beaucoup', 'comment allez-vous', 'quel est votre nom', 'au revoir'];
    const percentToCompare = [90,90,90,90,90];
    let result = false;
    ...
    speechRs.speechinit('Google français', function(e) {});
